...
const CONTACT_DETAILS = [
  { icon: <WhatsAppIcon />, label: 'WhatsApp', value: '11 96606-8951' },
  { icon: <EmailIcon />, label: 'E-mail', value: 'kodantech@gmail.com' },
  { icon: <InstagramIcon />, label: 'Instagram', value: '@kodantech' },
];
